from splendor_env_4p_p1g2 import SplendorEnv4PP1G2
from sb3_contrib import MaskablePPO
from stable_baselines3.common.monitor import Monitor
import os

# 0. Get names from user
opp_name = input("Enter the name of the OPPONENT model (Gen 1) (default: ai_4p_p1g1): ").strip()
if not opp_name:
    opp_name = "ai_4p_p1g1"

model_name = input("Enter a name for the NEW trained model (Gen 2) (default: ai_4p_p1g2): ").strip()
if not model_name:
    model_name = "ai_4p_p1g2"
...
env = SplendorEnv4PP1G2(num_players=4, opponent_model_path=f"models/{opp_name}.zip")
