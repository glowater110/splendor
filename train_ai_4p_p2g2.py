from splendor_env_4p_p2g2 import SplendorEnv4PP2G2
from sb3_contrib import MaskablePPO
from stable_baselines3.common.monitor import Monitor
import os

# 0. Get names from user
opp_name = input("Enter the name of the OPPONENT model (P2G1) (default: ai_4p_p2g1): ").strip()
if not opp_name:
    opp_name = "ai_4p_p2g1"

model_name = input("Enter a name for the NEW trained model (P2G2) (default: ai_4p_p2g2): ").strip()
if not model_name:
    model_name = "ai_4p_p2g2"
...
env = SplendorEnv4PP2G2(num_players=4, opponent_model_path=f"models/{opp_name}.zip")
